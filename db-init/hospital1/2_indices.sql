...
--CREATE INDEX idx_survey_person_id_1 ON public.survey_conduct (person_id ASC);


--CREATE INDEX idx_episode_person_id_1 ON public.episode (person_id ASC);
--CREATE INDEX idx_episode_concept_id_1 ON public.episode (episode_concept_id ASC);

--CREATE INDEX idx_episode_event_id_1 ON public.episode_event (episode_id ASC);
